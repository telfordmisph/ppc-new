...
//         <div className="flex">
//             <div
//                 className={` border-r-[1px] min-h-screen min-w-[270px] space-y-6 px-4 pb-6 pt-4 ${
//                     theme === "light"
...
//                         />
//                     </svg>
//                     <p className="pl-1">{formattedAppName}</p>
//                 </Link>
    ...
    return (
        <div className="flex">
            ...
            >
                ...
                {/* Footer controls */}
                <div className="flex items-center justify-start pl-3 mt-auto space-x-4">
                    <label className="swap swap-rotate">
                        <input
                            type="checkbox"
                            checked={theme !== "light"}
            ...
            <dialog id="logoutModal" className="modal">
                <div className="modal-box">
                    <h3 className="text-lg font-bold">Confirm Logout?</h3>
                    <p className="py-4">Press ESC or click below to close</p>
                    <div className="modal-action">
                        <form method="dialog">
                            <button className="btn">Close</button>
                        </form>
