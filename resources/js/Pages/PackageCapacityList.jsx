...
const PackageCapacityList = () => {
	...
	const [selectedPackageCapacity, setSelectedPackageCapacity] = useState(null);
					...
					<tr key={idx}>
						...
						<td>
							...
							<span className="opacity-50">
								{formatFriendlyDate(packageGroup?.previous_from || "")}
							</span>
							)
						</td>
						...
						<td>
							...
							(
							<span className="opacity-50">
								{formatFriendlyDate(packageGroup?.latest_from || "")}
							</span>
							)
						</td>
					</tr>
