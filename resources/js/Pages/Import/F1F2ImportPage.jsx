...
const F1F2ImportPage = () => {
    ...
    const handleManualOUTImport = () => {
        ...
        runAsyncToast({
            action: () =>
                importOuts(route("import.manualImportOUTS"), {
                    body: formData,
                    isContentTypeInclude: false,
                    isFormData: true,
                }),
        ...
        <ImportPageLayout pageName="F1/F2">
            <div className="grid grid-cols-1 w-full gap-4">
                    ...
                    <div className="card-body">
                            ...
                            <div className="border border-base-content/10 p-2 rounded-lg">
                                {isManualWip ? (
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            ftprootWIPImportRef.current?.open()
                                        }
                                    >
                        ...
                        {importWipErrorData?.data?.partialSuccess != null && (
                            <div className="text-error border border-error p-4 rounded-lg flex items-center gap-2">
                                ...
                                <span>
                                    Import Interrupted.{" "}
                                    {importWipErrorData.data.partialSuccess}{" "}
                    ...
                    <div className="card-body">
                            ...
                            <div className="border border-base-content/10 rounded-lg p-2">
                                {isManualOuts ? (
                                    ...
                                    <button
                                        className="btn btn-primary mb-1"
                                        onClick={() =>
                                            ftprootOUTImportRef.current?.open()
                                        }
                                    >
                        ...
                        {importOutsErrorData?.data?.partialSuccess != null && (
                            <div className="text-error border border-error p-4 rounded-lg flex items-center gap-2">
                                ...
                                <span>
                                    Import Interrupted.{" "}
                                    {importOutsErrorData.data.partialSuccess}{" "}
                                    entries imported successfully. You might
                                    want to try again
                                </span>
                            </div>
                ...
                <div>
                    ...
                    >
                        <p className="py-4">
                            Are you sure? This will start the OUTS import.
                        ...
                        <p className="text-warning-content border-warning border rounded-lg bg-warning px-2 py-1 flex items-center gap-2 mb-2">
                            ...
                            overwrite all existing entries for this date.
                        </p>
                    ...
                    >
                        <p className="py-4">
                            Are you sure? This will start the WIP import.
                            Current import progress (if any) will block this
                            action. This will overwrite all existing entries for
                            this date.
                        </p>
                    ...
                    >
                        <p className="py-4">
                            Are you sure? This will start the OUT import.
                            Current import progress (if any) will block this
                            action. This will overwrite all existing entries for
                            this date.
                        </p>
